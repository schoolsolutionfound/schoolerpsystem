...
const styles = StyleSheet.create({
  ...
  roleBadge: { backgroundColor: '#E0F2FE', paddingHorizontal: 10, paddingVertical: 3, borderRadius: BorderRadius.chip, alignSelf: 'flex-start' },
  roleBadgeText: { fontSize: 11, fontWeight: '800', color: '#0284C7' },
