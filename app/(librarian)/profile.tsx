...
export default function LibrarianProfileScreen() {
  ...
  const fullName = useUserStore((s) => s.fullName) || 'Librarian';
  ...
  const libraryBadgeId = useUserStore((s) => s.libraryBadgeId) || '';
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          <View style={styles.card}>
            <View style={styles.avatarRow}>
              <View style={[styles.avatarCircle, { backgroundColor: '#FEE2E2' }]}>
                <Text style={[styles.avatarText, { color: '#DC2626' }]}>{fullName.substring(0, 2).toUpperCase()}</Text>
              </View>
              <View style={{ flex: 1 }}>
                ...
                <View style={styles.badgeRow}>
                  <View style={[styles.roleBadge, { backgroundColor: '#FEE2E2' }]}>
                    <Text style={[styles.roleBadgeText, { color: '#DC2626' }]}>Librarian</Text>
                  </View>
                </View>
              </View>
            </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Library Badge ID</Text>
              <Text style={styles.infoValue}>{libraryBadgeId || '—'}</Text>
            </View>
          </View>
