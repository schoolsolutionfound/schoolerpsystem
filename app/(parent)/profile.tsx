    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safe}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          <View style={styles.card}>
            <View style={styles.avatarRow}>
              <View style={[styles.avatarCircle, { backgroundColor: '#DBEAFE' }]}>
                <Text style={[styles.avatarText, { color: '#2563EB' }]}>{fullName.substring(0, 2).toUpperCase()}</Text>
              </View>
              <View style={{ flex: 1 }}>
                ...
                <View style={styles.badgeRow}>
                  <View style={[styles.roleBadge, { backgroundColor: '#DBEAFE' }]}>
                    <Text style={[styles.roleBadgeText, { color: '#2563EB' }]}>Parent</Text>
                  </View>
                </View>
              </View>
            </View>
          ...
          <View style={styles.card}>
            <Text style={styles.sectionTitle}>Linked Student</Text>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Student USN / Roll No</Text>
              <Text style={styles.infoValue}>{linkedStudentUSN || '—'}</Text>
            </View>
            <View style={styles.infoRow}>
