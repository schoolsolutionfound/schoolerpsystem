      ...
      <View style={styles.sectionCard}>
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <TextInput style={styles.input} placeholder="e.g. LIB-301" placeholderTextColor="#6B6B6B" value={employeeId} onChangeText={setEmployeeId} />
          </View>
        </View>
        <View style={styles.inputGroup}>
          <Text style={styles.inputLabel}>Library Badge ID</Text>
          <View style={styles.inputWrapper}>
            <MaterialCommunityIcons name="badge-account-outline" size={18} color="#F4C430" style={styles.iconPrefix} />
            <TextInput style={styles.input} placeholder="e.g. BADGE-001" placeholderTextColor="#6B6B6B" value={libraryBadgeId} onChangeText={setLibraryBadgeId} />
          </View>
        </View>
      </View>
      <View style={styles.sectionCard}>
