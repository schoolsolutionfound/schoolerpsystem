...
interface LibrarianCompleteProfileFormProps {
  fullName: string;
  email: string;
  phone: string;
  ...
  setLibraryBadgeId: (val: string) => void;
...
export const LibrarianCompleteProfileForm: React.FC<LibrarianCompleteProfileFormProps> = ({
  fullName, email, phone, setPhone, employeeId, setEmployeeId, libraryBadgeId, setLibraryBadgeId, profilePicUri, onPickImage, loading, onSubmit,
}) => {
  return (
    <View style={styles.formWrap}>
      ...
      <View style={styles.sectionCard}>
        <Text style={styles.sectionHeaderTitle}>Library Details</Text>
        <View style={styles.inputGroup}>
          <Text style={styles.inputLabel}>Employee ID</Text>
          <View style={styles.inputWrapper}>
            <MaterialCommunityIcons name="card-account-details-outline" size={18} color="#7E57C2" style={styles.iconPrefix} />
            <TextInput style={styles.input} placeholder="e.g. LIB-301" placeholderTextColor="#A0AEC0" value={employeeId} onChangeText={setEmployeeId} />
          </View>
        </View>
        <View style={styles.inputGroup}>
          <Text style={styles.inputLabel}>Library Badge ID</Text>
          <View style={styles.inputWrapper}>
            <MaterialCommunityIcons name="badge-account-outline" size={18} color="#7E57C2" style={styles.iconPrefix} />
            <TextInput style={styles.input} placeholder="e.g. BADGE-001" placeholderTextColor="#A0AEC0" value={libraryBadgeId} onChangeText={setLibraryBadgeId} />
          </View>
        </View>
      </View>
      <View style={styles.sectionCard}>
