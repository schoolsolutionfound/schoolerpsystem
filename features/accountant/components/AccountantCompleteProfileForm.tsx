      ...
      <View style={styles.sectionCard}>
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <TextInput style={styles.input} placeholder="e.g. ACC-201" placeholderTextColor="#6B6B6B" value={employeeId} onChangeText={setEmployeeId} />
          </View>
        </View>
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <TextInput style={styles.input} placeholder="e.g. B.Com, M.Com, CA" placeholderTextColor="#6B6B6B" value={qualification} onChangeText={setQualification} />
          </View>
        </View>
      </View>
      <View style={styles.sectionCard}>
