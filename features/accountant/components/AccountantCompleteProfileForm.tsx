      ...
      <View style={styles.sectionCard}>
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <TextInput style={styles.input} placeholder="e.g. ACC-201" placeholderTextColor="#A0AEC0" value={employeeId} onChangeText={setEmployeeId} />
          </View>
        </View>
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <TextInput style={styles.input} placeholder="e.g. B.Com, M.Com, CA" placeholderTextColor="#A0AEC0" value={qualification} onChangeText={setQualification} />
          </View>
        </View>
      </View>
      <View style={styles.sectionCard}>
