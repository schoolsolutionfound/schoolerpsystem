...
interface AccountantCompleteProfileFormProps {
  fullName: string;
  email: string;
  phone: string;
...
export const AccountantCompleteProfileForm: React.FC<AccountantCompleteProfileFormProps> = ({
  fullName, email, phone, setPhone, employeeId, setEmployeeId, qualification, setQualification, profilePicUri, onPickImage, loading, onSubmit,
}) => {
  return (
    <View style={styles.formWrap}>
      <View style={styles.sectionCard}>
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.readOnlyWrapper}>
            ...
            <MaterialCommunityIcons name="lock-outline" size={18} color="#8A8A8A" />
          </View>
        </View>
        <View style={styles.inputGroup}>
      ...
      <View style={styles.sectionCard}>
        <Text style={styles.sectionHeaderTitle}>Employment & Qualification</Text>
        <View style={styles.inputGroup}>
          <Text style={styles.inputLabel}>Employee ID</Text>
          <View style={styles.inputWrapper}>
            <MaterialCommunityIcons name="card-account-details-outline" size={18} color="#F4C430" style={styles.iconPrefix} />
            <TextInput style={styles.input} placeholder="e.g. ACC-201" placeholderTextColor="#8A8A8A" value={employeeId} onChangeText={setEmployeeId} />
          </View>
        </View>
        <View style={styles.inputGroup}>
          <Text style={styles.inputLabel}>Qualification</Text>
          <View style={styles.inputWrapper}>
            <MaterialCommunityIcons name="school-outline" size={18} color="#F4C430" style={styles.iconPrefix} />
            <TextInput style={styles.input} placeholder="e.g. B.Com, M.Com, CA" placeholderTextColor="#8A8A8A" value={qualification} onChangeText={setQualification} />
          </View>
        </View>
      </View>
      <View style={styles.sectionCard}>
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <TextInput style={styles.input} placeholder="Enter your phone number" placeholderTextColor="#8A8A8A" keyboardType="phone-pad" value={phone} onChangeText={setPhone} />
          </View>
        </View>
        <View style={styles.inputGroup}>
...
const styles = StyleSheet.create({
  ...
  readOnlyText: { fontSize: 13, color: '#8A8A8A', fontWeight: '500', fontFamily: FontFamily.medium },
