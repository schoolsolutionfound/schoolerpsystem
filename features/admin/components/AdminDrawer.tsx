            ...
            >
              ...
              {SECONDARY.map((item) => (
                <TouchableOpacity
                  ...
                  style={styles.menuItem}
                  activeOpacity={0.7}
                  onPress={() => handleRoutePress(`/${item.key === 'change-password' ? 'change-password' : item.key}`)}
                >
                  <View style={styles.menuIcon}>
                    <MaterialCommunityIcons
                      name={item.icon as any}
