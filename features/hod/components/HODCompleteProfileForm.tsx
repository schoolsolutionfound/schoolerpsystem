      ...
      <View style={styles.sectionCard}>
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <TextInput style={styles.input} placeholder="e.g. Computer Science" placeholderTextColor="#A0AEC0" value={department} onChangeText={setDepartment} />
          </View>
        </View>
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <TextInput style={styles.input} placeholder="e.g. HOD-101" placeholderTextColor="#A0AEC0" value={employeeId} onChangeText={setEmployeeId} />
          </View>
        </View>
      </View>
      <View style={styles.sectionCard}>
