...
interface HODCompleteProfileFormProps {
  fullName: string;
  email: string;
  phone: string;
...
export const HODCompleteProfileForm: React.FC<HODCompleteProfileFormProps> = ({
  fullName, email, phone, setPhone, department, setDepartment, employeeId, setEmployeeId, profilePicUri, onPickImage, loading, onSubmit,
}) => {
  return (
    <View style={styles.formWrap}>
      ...
      <View style={styles.sectionCard}>
        <Text style={styles.sectionHeaderTitle}>Department & Employment</Text>
        <View style={styles.inputGroup}>
          <Text style={styles.inputLabel}>Department</Text>
          <View style={styles.inputWrapper}>
            <MaterialCommunityIcons name="school-outline" size={18} color="#F4C430" style={styles.iconPrefix} />
            <TextInput style={styles.input} placeholder="e.g. Computer Science" placeholderTextColor="#6B6B6B" value={department} onChangeText={setDepartment} />
          </View>
        </View>
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <TextInput style={styles.input} placeholder="e.g. HOD-101" placeholderTextColor="#6B6B6B" value={employeeId} onChangeText={setEmployeeId} />
          </View>
        </View>
      </View>
      <View style={styles.sectionCard}>
