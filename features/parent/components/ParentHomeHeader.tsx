...
export const ParentHomeHeader: React.FC<ParentHomeHeaderProps> = ({
  fullName,
  profilePic,
  onMenuPress,
    ...
    <View style={styles.container}>
      <View style={styles.topHeader}>
        ...
        <View style={styles.iconBtn}>
          <Feather name="bell" size={22} color="#C0C0C0" />
        </View>
      </View>
        ...
        <View style={styles.avatarWrap}>
          {profilePic ? (
            ...
            <View style={styles.avatarPlaceholder}>
              <MaterialCommunityIcons name="account-heart" size={32} color="#1A1B1C" />
            </View>
          )}
        </View>
...
const styles = StyleSheet.create({
  ...
  greetingText: { fontSize: 14, fontFamily: FontFamily.regular, color: '#6B6B6B', marginBottom: 2 },
  userNameText: { fontSize: 22, fontFamily: FontFamily.extrabold, color: '#171717' },
});
